...
- [x] `@crab-dev/standards-eslint-react-preset` ESLint 代码规范的一些预设值
- [x] `@crab-dev/standards-typescript-preset` TypeScript 的一些预设配置
- [x] `@crab-dev/packify`  用来构建依赖库的打包工具
- [x] `@crab-dev/crustify` 用来构建 React 开发的构建器
- [x] `@crab-dev/styleify` 抽象基础样式，提供组件使用
- [ ] 基础组件开发
    - [ ] `@crab-dev/rc-button` 按钮
    - [ ] `@crab-dev/rc-frame` 布局组件，适用于管理后台、仪表盘等
    - [ ] `@crab-dev/rc-hooks` 一些 hooks 的工具库
    - [ ] `@crab-dev/rc-line-edit` 单行文本编辑器
...
> 采用 [Babel](https://babeljs.io/) 进行将代码转义, 支持的浏览器的范围 https://browsersl.ist/#q=defaults
