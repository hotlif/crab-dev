...
export const api = {
    ...
    "symbol": "CronPickerProps",
    "props": [
        {
            "name": "aria-label",
            "required": false,
            "description": "无障碍名称,默认 \"Cron 表达式\"",
            "typeText": "string",
            "defaultValue": null,
            "deprecated": false
        },
        ...
        },
        {
            "name": "onChange",
            "required": false,
            "description": "表达式变化回调,仅在产生合法表达式时触发",
        ...
        },
        {
            "name": "previewCount",
            "required": false,
            "description": "弹层内\"接下来执行时间\"预览条数,传 0 关闭预览,默认 5",
            "typeText": "number",
            "defaultValue": "5",
            "deprecated": false
        },
        ...
        },
        {
            "name": "status",
            "required": false,
            "description": "外部校验状态,影响边框颜色;输入了非法表达式时组件会自行显示 error 态",
        ...
        },
        {
            "name": "value",
            "required": false,
            "description": "受控值:五段式(分 时 日 月 周)cron 表达式",
            "typeText": "string",
            "defaultValue": null,
            "deprecated": false
        }
