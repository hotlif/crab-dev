...
export const api = {
    ...
    "props": [
        ...
        },
        {
            "name": "children",
            "required": false,
            "description": "卡片内容：裸内容自动包裹进内容区; 传入 Card.Cover / Card.Header / Card.Body / Card.Footer 时切换为自由拼装模式",
            "typeText": "ReactNode",
            "defaultValue": null,
            "deprecated": false
        },
        {
            "name": "clickable",
            "required": false,
            "description": "整卡是否可点击：自带浮起反馈 / 键盘激活（Enter / Space）/ 焦点环, 卡内 extra 与 actions 的点击自动与整卡点击隔离",
            "typeText": "boolean",
            "defaultValue": "false",
            "deprecated": false
        },
        ...
        },
        {
            ...
            "typeText": "MouseEventHandler\u003cHTMLDivElement>",
            "defaultValue": null,
            "deprecated": false
        },
        {
