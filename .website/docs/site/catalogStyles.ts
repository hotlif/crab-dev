...
.crab-catalog-categories { display: flex; flex-wrap: wrap; gap: ${token.space["component-gap"]}; padding-block: ${token.space["section-gap"]}; border-block: 1px solid ${token.color.border.subtle}; }
.crab-catalog-categories a { height: auto; min-height: ${globalToken.space[10]}; padding: ${token.space["component-gap"]} ${token.space["stack-gap"]}; color: ${token.color.text.secondary}; font-size: ${token.font.size.body}; border-radius: ${token.radius.md}; }
.crab-catalog-categories a > span { display: flex; gap: ${token.space["stack-gap"]}; align-items: center; }
...
.crab-catalog-categories a:hover { background: var(--crab-docs-nav-hover); color: ${token.color.text.primary}; }
...
.crab-catalog-section-heading h2 { margin: 0; font-size: ${globalToken.font.size.xl}; font-weight: ${token.font.weight.heading}; line-height: 1.4; letter-spacing: -.02em; }
...
.crab-catalog-grid .crab-catalog-item { display: block; height: 100%; min-width: 0; width: 100%; padding: ${token.space["section-gap"]}; border: ${globalToken.space.px} solid transparent; border-radius: ${token.radius.lg}; text-align: left; white-space: normal; color: ${token.color.text.primary}; background: ${token.color.background.surface}; box-shadow: none; transition: background ${token.motion.interaction}, border-color ${token.motion.interaction}; }
.crab-catalog-item > span { display: block; min-width: 0; }
.crab-catalog-item-heading { display: flex; align-items: center; justify-content: space-between; gap: ${token.space["component-gap"]}; }
...
.crab-catalog-item-heading strong { min-width: 0; overflow-wrap: anywhere; font-size: ${token.font.size.body}; font-weight: ${token.font.weight.heading}; line-height: 1.5; }
...
.crab-catalog-artwork { display: flex; align-items: center; justify-content: center; padding-block: ${token.space["stack-gap"]}; }
...
.crab-catalog-item-description { display: block; color: ${token.color.text.secondary}; font-size: ${token.font.size.body}; font-weight: ${token.font.weight.body}; line-height: 1.65; overflow-wrap: anywhere; }
...
@media (max-width: 767px) {
    ...
    .crab-catalog-actions a, .crab-catalog-categories a { min-height: calc(${globalToken.space[10]} + ${globalToken.space[1]}); }
    .crab-catalog-categories { gap: ${token.space["inline-gap"]}; }
