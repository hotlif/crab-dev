...
// Documentation layout metrics; typography and controls use the shared M3 roles.
const docs = defineTokens({
    rail: "80px", drawer: "280px", max: "1760px", article: "1200px", outline: "176px", measure: "88ch",
});
...
.crab-docs-layout .crab-docs-page-heading { display: grid; grid-template-columns: minmax(0,1fr); padding: ${globalToken.space[8]}; border-radius: ${globalToken.space[6]}; background: ${token.color.surface.low}; gap: ${globalToken.space[4]}; margin: 0; }
.crab-docs-layout .crab-docs-page-heading h1 { margin: 0; font-size: ${token.typography.display.small["font-size"]}; line-height: ${token.typography.display.small["line-height"]}; font-weight: ${token.typography.display.small["font-weight"]}; letter-spacing: normal; text-wrap: balance; overflow-wrap: anywhere; }
.crab-docs-layout .crab-docs-page-heading > p { margin: 0; max-width: 64ch; font-size: ${token.typography.body.large["font-size"]}; line-height: ${token.typography.body.large["line-height"]}; color: ${token.color.text.primary}; text-wrap: pretty; }
...
/* A single chapter outline sits beside the article or collapses above it. */
...
.crab-docs-component-artwork { display: grid; place-items: center; position: relative; isolation: isolate; overflow: hidden; width: 100%; height: calc(${globalToken.space[24]} + ${globalToken.space[6]}); border-radius: ${globalToken.space[6]}; background: ${token.color.secondary.container}; }
...
.crab-docs-component-artwork .crab-catalog-preview { width: auto; max-width: 100%; min-width: 0; min-height: 0; height: calc(${globalToken.space[24]} + ${globalToken.space[6]}); }
.crab-docs-reading-body { margin: ${globalToken.space[6]} auto 0; }
.crab-docs-page-outline { min-width: 0; max-width: ${docs.article}; margin: 0 auto ${globalToken.space[4]}; padding-inline: ${globalToken.space[8]}; }
.crab-docs-page-outline .crab-docs-outline-toggle { min-height: ${token.size[48]}; }
.crab-docs-outline-toggle svg { width: ${globalToken.space[6]}; height: ${globalToken.space[6]}; fill: none; stroke: currentColor; stroke-width: 2; transition: transform ${token.motion.spatial.fast}; }
.crab-docs-outline-toggle[aria-expanded="true"] svg { transform: rotate(180deg); }
.crab-docs-outline-label { margin: 0 0 ${globalToken.space[3]}; padding-inline: ${globalToken.space[3]}; font-size: ${token.typography.label.large["font-size"]}; line-height: ${token.typography.label.large["line-height"]}; font-weight: ${token.font.weight.label}; color: ${token.color.text.secondary}; }
...
.crab-docs-page[data-reading="true"] .crab-docs-reading-body > .crab-docs-prose { container: docs-article / inline-size; min-width: 0; max-width: ${docs.article}; margin-inline: auto; padding: 0 ${globalToken.space[8]} ${globalToken.space[12]}; font-size: ${token.typography.body.large["font-size"]}; line-height: ${token.typography.body.large["line-height"]}; }
.crab-docs-page[data-reading="true"] .crab-docs-prose > p { max-width: ${docs.measure}; margin-block: ${globalToken.space[4]}; }
.crab-docs-page[data-reading="true"] .crab-docs-prose > :is(ul,ol) { padding-inline-start: ${globalToken.space[6]}; }
.crab-docs-page[data-reading="true"] .crab-docs-prose :is(h2,h3,[data-docs-example-anchor])[id] { scroll-margin-top: ${globalToken.space[6]}; }
.crab-docs-page[data-reading="true"] .crab-docs-prose > h2 { font-size: ${token.typography.headline.medium["font-size"]}; line-height: ${token.typography.headline.medium["line-height"]}; margin: ${globalToken.space[10]} 0 ${globalToken.space[5]}; }
...
.crab-docs-page[data-reading="true"] .crab-docs-prose > [data-docs-example-anchor] + h2,
...
.crab-docs-page-heading .crab-docs-motion-note { margin-block: ${token.space["component-gap"]} 0; font-size: ${token.typography.body.small["font-size"]}; line-height: ${token.typography.body.small["line-height"]}; color: ${token.color.text.secondary}; }
...
.crab-docs-reading-body[data-wide="true"] { display: grid; grid-template-columns: minmax(0,1fr) ${docs.outline}; align-items: start; gap: ${globalToken.space[8]}; max-width: calc(${docs.article} + ${globalToken.space[24]}); padding-inline: ${globalToken.space[6]}; margin-top: ${globalToken.space[8]}; }
.crab-docs-page[data-reading="true"] .crab-docs-reading-body[data-wide="true"] > .crab-docs-prose { width: 100%; padding-inline: 0; }
.crab-docs-reading-body[data-wide="true"] .crab-docs-page-outline { position: sticky; top: ${globalToken.space[6]}; max-height: calc(100dvh - ${globalToken.space[12]}); overflow-y: auto; scrollbar-width: thin; margin: 0; padding: 0; }
.crab-docs-reading-body[data-wide="true"] .crab-docs-page-sections { border: 0; }
.crab-docs-reading-body[data-wide="true"] .crab-docs-page-sections a { padding-inline: ${globalToken.space[3]}; font-size: ${token.typography.body.medium["font-size"]}; line-height: ${token.typography.body.medium["line-height"]}; }
/* The page owns scrolling; keep the hero and outline visible without a second scrollbar. */
.crab-docs-layout[data-reading="true"] .crab-docs-page-hero { position: sticky; top: 0; z-index: 10; padding-bottom: ${globalToken.space[2]}; margin-bottom: 0; background: ${token.color.surface.canvas}; }
.crab-docs-layout[data-reading="true"] .crab-docs-reading-body[data-wide="true"] .crab-docs-page-outline { top: calc(var(--crab-docs-hero-height, 0px) + ${globalToken.space[6]}); max-height: max(${token.size[48]}, calc(100dvh - var(--crab-docs-hero-height, 0px) - ${globalToken.space[12]})); }
.crab-docs-layout[data-reading="true"] .crab-docs-prose :is(h2,h3,[data-docs-example-anchor])[id] { scroll-margin-top: calc(var(--crab-docs-hero-height, 0px) + ${globalToken.space[6]}); }
@container (min-width: 800px) {
    .crab-docs-page-hero:has(.crab-docs-component-artwork) { grid-template-columns: minmax(0,1fr) minmax(0,calc(${globalToken.space[24]} * 3)); }
    .crab-docs-page-hero:has(.crab-docs-component-artwork) .crab-docs-page-heading { align-content: center; }
    .crab-docs-component-artwork { height: 100%; }
    .crab-docs-component-artwork .crab-catalog-preview { height: calc(${globalToken.space[24]} * 2); }
}
@container (max-width: 999px) {
    .crab-docs-page[data-reading="true"] .crab-docs-reading-body > .crab-docs-prose { padding-inline: ${globalToken.space[8]}; }
}
@media (max-width: 1279px) {
    ...
    .crab-docs-layout[data-reading="true"] .crab-docs-page-hero { top: ${globalToken.size[64]}; }
    .crab-docs-layout[data-reading="true"] .crab-docs-reading-body[data-wide="true"] .crab-docs-page-outline { top: calc(${globalToken.size[64]} + var(--crab-docs-hero-height, 0px) + ${globalToken.space[6]}); }
    .crab-docs-layout[data-reading="true"] .crab-docs-prose :is(h2,h3,[data-docs-example-anchor])[id] { scroll-margin-top: calc(${globalToken.size[64]} + var(--crab-docs-hero-height, 0px) + ${globalToken.space[6]}); }
    ...
    .crab-docs-page[data-reading="true"] .crab-docs-prose :is(h2,h3,[data-docs-example-anchor])[id] { scroll-margin-top: calc(${globalToken.size[64]} + ${globalToken.space[6]}); }
    .crab-docs-reading-body[data-wide="true"] .crab-docs-page-outline { top: calc(${globalToken.size[64]} + ${globalToken.space[6]}); max-height: calc(100dvh - ${globalToken.size[64]} - ${globalToken.space[12]}); }
}
@media (max-width: 599px) {
    .crab-docs-layout[data-reading="true"] .crab-docs-page-hero { position: static; }
    .crab-docs-layout[data-reading="true"] .crab-docs-prose :is(h2,h3,[data-docs-example-anchor])[id] { scroll-margin-top: calc(${globalToken.size[64]} + ${globalToken.space[6]}); }
    ...
    .crab-docs-page-outline { padding-inline: ${globalToken.space[4]}; }
...
@media (forced-colors: active) {
    ...
    .crab-docs-page-heading,.crab-docs-pager a,.crab-docs-component-artwork { border: ${globalToken.space.px} solid CanvasText; }
    .crab-docs-component-artwork::before,.crab-docs-component-artwork::after { display: none; }
    .crab-docs-page-sections a[aria-current],.crab-docs-rail-item[data-active="true"] .crab-docs-rail-indicator { outline: ${globalToken.space["0-5"]} solid Highlight; outline-offset: -${globalToken.space[1]}; }
}
`;
