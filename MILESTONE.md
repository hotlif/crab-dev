...
> 记录日期：2026-08-26 &nbsp;|&nbsp; 当时阶段：**Alpha（v0.x）**
>
> 本文保留该阶段的交付情况和规划，不代表当前版本的完整能力。当前包目录见 [README](./README.md)，具体功能与 API 见各组件的 `docs/index.mdx`。下文中的包名、版本、数量和待办均按记录时点理解。
...
> 本期重点：**新增图形与可视化组件**：`rc-canvas`（纯 WebGL 2 的 2D 绘制引擎，提供 Rect /
