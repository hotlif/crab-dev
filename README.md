<div align="center">
	<h1>Carb Dev</h1>
	最佳实践, 并且安全可靠, 并且所有的库将对 Yarn Plug'n'Play 采用最优先的支持
</div>

## Roadmap 线路图

- `@crab/standards-eslint-react-preset` ESLint 代码规范的一些预设值
	- [x] 预设 React 的 ESLint 的规则
	- [x] 预设 Node 的 ESLint 的规则
- `@crab/standards-typescript-preset` TypeScript 的一些预设配置
	- [x] 预设 React 的 TypeScript 的规则
