...
const columns: ColumnType<DemoRow>[] = [
    { title: "工号", name: "$.employeeNo", width: 140 },
    { title: "姓名", name: "$.name", width: 140 },
    { title: "年龄", name: "$.age", width: 100, align: "right" },
    { title: "邮箱", name: "$.email", width: 260 },
    { title: "电话", name: "$.phone", width: 180 },
    ...
    { title: "入职日期", name: "$.createdAt", width: 160 },
]
