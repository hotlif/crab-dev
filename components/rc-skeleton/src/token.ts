...
const token = defineTokens({
    ...
    'wave': {
        'background-color': `var(${vars['wave.background-color']}, var(--token-semantic-color-background-active-subtle, color-mix(in oklch, var(--token-global-material-neutral-10, oklch(0.22652446 0.00999107 303.713695)) calc(var(--token-semantic-state-opacity-pressed, var(--token-global-opacity-12, 0.12)) * 100%), var(--token-global-material-neutral-98, oklch(0.98379491 0.01284496 321.893957)))))`
    },
    'item': {
        'border-radius': `var(${vars['item.border-radius']}, var(--token-semantic-shape-control, var(--token-global-radius-2, 4px)))`
    },
    'text': {
        'border-radius': `var(${vars['text.border-radius']}, var(--token-semantic-radius-sm, var(--token-global-radius-2, 4px)))`,
        'size': {
            'small': {
    ...
    'circle': {
        'default': {
            'width': `var(${vars['circle.default.width']}, 40px)`
        }
    },
    'button': {
        'default': {
    ...
    'avatar': {
        'default': {
            'width': `var(${vars['avatar.default.width']}, 40px)`
        }
    },
    'animation': {
        'pulse': {
            'animation-duration': `var(${vars['animation.pulse.animation-duration']}, 1600ms)`,
            'animation-timing-function': `var(${vars['animation.pulse.animation-timing-function']}, cubic-bezier(0.4, 0, 0.6, 1))`,
            'minimum': {
                'opacity': `var(${vars['animation.pulse.minimum.opacity']}, var(--token-semantic-opacity-secondary, var(--token-global-opacity-50, 0.5)))`
            },
            'maximum': {
                'opacity': `var(${vars['animation.pulse.maximum.opacity']}, 1)`
            }
        },
        'wave': {
            'animation-duration': `var(${vars['animation.wave.animation-duration']}, 1600ms)`,
            'animation-timing-function': `var(${vars['animation.wave.animation-timing-function']}, cubic-bezier(0.4, 0, 0.2, 1))`
        }
    }
});
