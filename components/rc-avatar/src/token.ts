...
const token = defineTokens({
    'root': {
        ...
        'border-color': `var(${vars['root.border-color']}, var(--avatar-border-color, var(--token-semantic-color-border-default, var(--token-global-zinc-500, oklch(0.660 0.014 286)))))`,
        'border-color-hover': `var(${vars['root.border-color-hover']}, var(--avatar-border-color-hover, var(--avatar-border-hover, var(--token-semantic-color-border-hover, var(--token-global-zinc-600, oklch(0.550 0.014 286))))))`,
    ...
    'ring': {
        'color-focus': `var(${vars['ring.color-focus']}, var(--avatar-focus-ring-color, var(--token-semantic-color-focus-ring, var(--token-semantic-color-border-focus, var(--token-global-blue-600, oklch(0.546 0.245 262))))))`
    },
    'default': {
