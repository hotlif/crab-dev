...
const token = defineTokens({
    ...
    'header': {
        ...
        'border-color': `var(${vars['header.border-color']}, var(--token-semantic-color-border-default, var(--token-global-zinc-500, oklch(0.660 0.014 286))))`,
        'title': {
    ...
    'footer': {
        ...
        'border-color': `var(${vars['footer.border-color']}, var(--token-semantic-color-border-default, var(--token-global-zinc-500, oklch(0.660 0.014 286))))`,
