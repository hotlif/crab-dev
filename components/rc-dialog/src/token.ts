...
const token = defineTokens({
    ...
    'root': {
        'background-color': `var(${vars['root.background-color']}, var(--dialog-background-color, var(--token-semantic-color-surface-high, var(--token-global-material-neutral-92, oklch(0.93250577 0.01478797 312.240074)))))`,
        'top': `var(${vars['root.top']}, var(--dialog-top, 50%))`,
        'transform': `var(${vars['root.transform']}, translateY(calc(var(--dialog-top, 0px) - var(--dialog-top, 50%))))`,
        'min-width': `var(${vars['root.min-width']}, var(--dialog-min-width, 280px))`,
        ...
        'padding': `var(${vars['root.padding']}, var(--dialog-padding, var(--token-semantic-space-dialog-padding, var(--token-global-space-6, 24px))))`,
        'border-radius': `var(${vars['root.border-radius']}, var(--dialog-border-radius, var(--token-semantic-shape-overlay, var(--token-global-radius-14, 28px))))`,
        'box-shadow': `var(${vars['root.box-shadow']}, var(--dialog-box-shadow, var(--token-semantic-shadow-overlay, var(--token-global-shadow-material-3, 0 1px 3px 0 oklch(0 0 0 / 0.3), 0 4px 8px 3px oklch(0 0 0 / 0.15)))))`
    },
    'confirm': {
    ...
    'motion': {
        'fade': {
            'transition': `var(${vars['motion.fade.transition']}, var(--dialog-motion-fade, var(--token-semantic-motion-fade, var(--token-global-duration-normal, 200ms) var(--token-global-easing-expressive-effects-default, cubic-bezier(0.34, 0.80, 0.34, 1.00)))))`
        },
        'interaction': {
            'transition': `var(${vars['motion.interaction.transition']}, var(--dialog-motion-interaction, var(--token-semantic-motion-interaction, var(--token-global-duration-150, 150ms) var(--token-global-easing-expressive-effects-fast, cubic-bezier(0.31, 0.94, 0.34, 1.00)))))`
        },
        'offset': {
