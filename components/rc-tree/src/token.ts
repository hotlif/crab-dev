...
export const vars = defineTokens({
    ...
    'node.selection.text-decoration': '--tree-node-selection-text-decoration',
    ...
    'motion.arrow.transition': '--tree-motion-arrow-transition',
    'motion.rows.transition': '--tree-motion-rows-transition'
});

const token = defineTokens({
    'indent': {
        'width': `var(${vars['indent.width']}, var(--token-semantic-space-section-gap, var(--token-global-space-4, 16px)))`
    },
    'root': {
    ...
    'node': {
        ...
        'background-color-selected': `var(${vars['node.background-color-selected']}, var(--token-semantic-color-secondary-container, var(--token-global-material-secondary-90, oklch(0.91633372 0.03651492 303.106047))))`,
        'selection': {
            'border-color': `var(${vars['node.selection.border-color']}, var(--token-semantic-color-selection-border, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`,
            'border-width': `var(${vars['node.selection.border-width']}, 3px)`,
            'text-decoration': `var(${vars['node.selection.text-decoration']}, underline)`,
        ...
        'icon': {
            ...
            'color-loading': `var(${vars['node.icon.color-loading']}, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`
        },
        'indent-line': {
            'border-color': `var(${vars['node.indent-line.border-color']}, var(--token-semantic-color-border-default, var(--token-global-material-neutral-variant-50, oklch(0.56674707 0.01627446 308.142182))))`
        },
        'draggable': {
        ...
        'drag': {
            'indicator': {
                'background-color': `var(${vars['node.drag.indicator.background-color']}, var(--token-semantic-color-feedback-info-border, var(--token-global-blue-600, oklch(0.546 0.245 262))))`
            },
            'inside': {
                ...
                'border-color': `var(${vars['node.drag.inside.border-color']}, var(--token-semantic-color-feedback-info-border, var(--token-global-blue-600, oklch(0.546 0.245 262))))`
            },
            'badge': {
                'background-color': `var(${vars['node.drag.badge.background-color']}, var(--token-semantic-color-feedback-info-solid, var(--token-global-blue-600, oklch(0.546 0.245 262))))`,
        ...
        'color-disabled': `var(${vars['node.color-disabled']}, var(--token-semantic-color-text-disabled, var(--token-global-material-neutral-10, oklch(0.22652446 0.00999107 303.713695))))`,
        'background-color-disabled': `var(${vars['node.background-color-disabled']}, transparent)`,
    ...
    'motion': {
        'arrow': {
            'transition': `var(${vars['motion.arrow.transition']}, var(--token-semantic-motion-spatial-fast, var(--token-global-duration-350, 350ms) var(--token-global-easing-expressive-spatial-fast, cubic-bezier(0.42, 1.67, 0.21, 0.90))))`
        },
        'rows': {
