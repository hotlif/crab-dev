...
export const vars = defineTokens({
    ...
    'root.radius': '--pdf-editor-root-radius',
    ...
    'toolbar.icon-size': '--pdf-editor-toolbar-icon-size',
    'toolbar.target-size': '--pdf-editor-toolbar-target-size',
    'toolbar.icon-color': '--pdf-editor-toolbar-icon-color',
    'toolbar.icon-hover': '--pdf-editor-toolbar-icon-hover',
    'toolbar.icon-focus': '--pdf-editor-toolbar-icon-focus',
    'toolbar.icon-pressed': '--pdf-editor-toolbar-icon-pressed',
    ...
    'objects.icon-size': '--pdf-editor-objects-icon-size',
    ...
    'panel.heading-size': '--pdf-editor-panel-heading-size',
    'panel.heading-weight': '--pdf-editor-panel-heading-weight',
    'canvas.background': '--pdf-editor-canvas-background',
    'canvas.paper': '--pdf-editor-canvas-paper',
    ...
    'status.size': '--pdf-editor-status-size',
    ...
    'error.color': '--pdf-editor-error-color',
    'error.background': '--pdf-editor-error-background',
    'thumbnail.height': '--pdf-editor-thumbnail-height',
    'thumbnail.drop-width': '--pdf-editor-thumbnail-drop-width',
    'thumbnail.drop-color': '--pdf-editor-thumbnail-drop-color',
    'thumbnail.drag-background': '--pdf-editor-thumbnail-drag-background',
...
const token = defineTokens({
    'root': {
        ...
        'radius': `var(${vars['root.radius']}, var(--token-semantic-radius-lg, var(--token-global-radius-6, 12px)))`,
    ...
    'toolbar': {
        ...
        'file-name-min-width': `var(${vars['toolbar.file-name-min-width']}, var(--token-semantic-size-96, var(--token-global-size-96, 96px)))`,
        'icon-size': `var(${vars['toolbar.icon-size']}, var(--token-semantic-space-group-gap, var(--token-global-space-6, 24px)))`,
        'target-size': `var(${vars['toolbar.target-size']}, var(--token-semantic-size-touch-target, var(--token-global-size-48, 48px)))`,
        'icon-color': `var(${vars['toolbar.icon-color']}, var(--token-semantic-color-text-secondary, var(--token-global-material-neutral-variant-30, oklch(0.39805288 0.01735545 303.720936))))`,
        'icon-hover': `var(${vars['toolbar.icon-hover']}, color-mix(in oklch, var(--token-semantic-color-text-secondary, var(--token-global-material-neutral-variant-30, oklch(0.39805288 0.01735545 303.720936))) calc(var(--token-semantic-state-opacity-hover, var(--token-global-opacity-8, 0.08)) * 100%), transparent))`,
        'icon-focus': `var(${vars['toolbar.icon-focus']}, color-mix(in oklch, var(--token-semantic-color-text-secondary, var(--token-global-material-neutral-variant-30, oklch(0.39805288 0.01735545 303.720936))) calc(var(--token-semantic-state-opacity-focus, var(--token-global-opacity-12, 0.12)) * 100%), transparent))`,
        'icon-pressed': `var(${vars['toolbar.icon-pressed']}, color-mix(in oklch, var(--token-semantic-color-text-secondary, var(--token-global-material-neutral-variant-30, oklch(0.39805288 0.01735545 303.720936))) calc(var(--token-semantic-state-opacity-pressed, var(--token-global-opacity-12, 0.12)) * 100%), transparent))`
    },
    'objects': {
        ...
        'icon-size': `var(${vars['objects.icon-size']}, var(--token-semantic-space-section-gap, var(--token-global-space-4, 16px)))`
    },
    'panel': {
        'width': `var(${vars['panel.width']}, 240px)`,
        'properties-width': `var(${vars['panel.properties-width']}, 280px)`,
        ...
        'scroll-padding': `var(${vars['panel.scroll-padding']}, var(--token-semantic-space-inline-gap, var(--token-global-space-1, 4px)))`,
        ...
        'heading-size': `var(${vars['panel.heading-size']}, var(--token-semantic-font-size-subhead, var(--token-global-font-size-md, 16px)))`,
        'heading-weight': `var(${vars['panel.heading-weight']}, var(--token-semantic-font-weight-label, var(--token-global-font-weight-medium, 500)))`
    },
    'canvas': {
        ...
        'paper': `var(${vars['canvas.paper']}, oklch(1 0 0))`,
    ...
    'status': {
        ...
        'size': `var(${vars['status.size']}, var(--token-semantic-font-size-caption, var(--token-global-font-size-xs, 12px)))`,
        'padding-block': `var(${vars['status.padding-block']}, var(--token-semantic-space-inline-gap, var(--token-global-space-1, 4px)))`,
        'zoom-width': `var(${vars['status.zoom-width']}, calc(var(--token-semantic-size-64, var(--token-global-size-64, 64px)) + var(--token-semantic-space-component-gap, var(--token-global-space-2, 8px))))`,
        'zoom-height': `var(${vars['status.zoom-height']}, var(--token-semantic-size-32, var(--token-global-size-32, 32px)))`,
        'zoom-font-size': `var(${vars['status.zoom-font-size']}, var(--token-semantic-typography-label-large-font-size, var(--token-global-font-size-sm, 14px)))`,
        'zoom-line-height': `var(${vars['status.zoom-line-height']}, calc(var(--token-semantic-typography-label-large-font-size, var(--token-global-font-size-sm, 14px)) * var(--token-semantic-typography-label-large-line-height, var(--token-global-line-height-14-20, 1.4285714285714286))))`
    },
    'error': {
        'color': `var(${vars['error.color']}, var(--token-semantic-color-feedback-error-text, var(--token-semantic-color-feedback-error, var(--token-global-material-error-10, oklch(0.25390329 0.07937181 27.605486)))))`,
        'background': `var(${vars['error.background']}, var(--token-semantic-color-surface-container, var(--token-global-material-neutral-94, oklch(0.95362610 0.01470533 312.243326))))`
    },
    'thumbnail': {
        'height': `var(${vars['thumbnail.height']}, 200px)`,
        'drop-width': `var(${vars['thumbnail.drop-width']}, 2px)`,
        'drop-color': `var(${vars['thumbnail.drop-color']}, var(--token-semantic-color-selection-border, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`,
        'drag-background': `var(${vars['thumbnail.drag-background']}, var(--token-semantic-color-state-dragged, color-mix(in oklch, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))) calc(var(--token-semantic-state-opacity-dragged, var(--token-global-opacity-16, 0.16)) * 100%), transparent)))`,
        'image-width': `var(${vars['thumbnail.image-width']}, 160px)`,
        'image-height': `var(${vars['thumbnail.image-height']}, 152px)`
    }
});
