...
const token = defineTokens({
    'root': {
        'transition': `var(${vars['root.transition']}, var(--line-edit-transition, var(--token-semantic-motion-fade, var(--token-global-duration-normal, 200ms) var(--token-global-easing-default, cubic-bezier(0.4, 0, 0.2, 1)))))`,
        ...
        'border-color': `var(${vars['root.border-color']}, var(--line-edit-border-color, var(--token-semantic-color-border-default, var(--token-global-zinc-500, oklch(0.660 0.014 286)))))`,
        'border-color-hover': `var(${vars['root.border-color-hover']}, var(--line-edit-border-color-hover, var(--token-semantic-color-border-hover, var(--token-global-zinc-600, oklch(0.550 0.014 286)))))`,
        'border-color-focus': `var(${vars['root.border-color-focus']}, var(--line-edit-border-color-focus, var(--token-semantic-color-border-focus, var(--token-global-blue-600, oklch(0.546 0.245 262)))))`,
        'box-shadow': `var(${vars['root.box-shadow']}, var(--line-edit-box-shadow, var(--line-edit-box-shadow-default, none)))`,
        'box-shadow-focus-within': `var(${vars['root.box-shadow-focus-within']}, var(--line-edit-box-shadow-focus-within, var(--token-semantic-shadow-focus-ring, 0 0 0 3px var(--token-semantic-color-focus-ring, var(--token-semantic-color-border-focus, var(--token-global-blue-600, oklch(0.546 0.245 262)))))))`,
