...
const token = defineTokens({
    'root': {
        'transition': `var(${vars['root.transition']}, var(--badge-transition, background-color 100ms cubic-bezier(0.4, 0, 0.2, 1), color 100ms cubic-bezier(0.4, 0, 0.2, 1), transform 100ms cubic-bezier(0.4, 0, 0.2, 1)))`
    },
    'size': {
        'default': {
            ...
            'font-size': `var(${vars['size.default.font-size']}, var(--token-semantic-font-size-caption, var(--token-global-font-size-xs, 12px)))`,
            'border-width': `var(${vars['size.default.border-width']}, 2px)`
        },
        'small': {
    ...
    'dot': {
        'default': {
            'width': `var(${vars['dot.default.width']}, var(--badge-dot-size-default, 8px))`
        },
        'small': {
    ...
    'count': {
        'color': `var(${vars['count.color']}, var(--token-semantic-color-feedback-error-on-solid, var(--token-global-white, oklch(1.000 0 0))))`,
        'background-color': `var(${vars['count.background-color']}, var(--token-semantic-color-feedback-error-solid, var(--token-semantic-color-feedback-error, var(--token-global-red-600, oklch(0.577 0.245 25)))))`,
        ...
        'font-weight': `var(${vars['count.font-weight']}, var(--token-semantic-font-weight-label, var(--token-global-font-weight-medium, 500)))`
    },
    'status': {
        'default': {
        ...
        'color-error': `var(${vars['status.color-error']}, var(--badge-status-error-color, var(--token-semantic-color-feedback-error-icon, var(--token-semantic-color-feedback-error, var(--token-global-red-600, oklch(0.577 0.245 25))))))`,
        'text': {
            ...
            'font-size': `var(${vars['status.text.font-size']}, var(--token-semantic-font-size-body, var(--token-global-font-size-sm, 14px)))`
        }
    },
    'indicator': {
