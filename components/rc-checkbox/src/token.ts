...
const token = defineTokens({
    ...
    'control': {
        ...
        'target': {
            'width': `var(${vars['control.target.width']}, 40px)`
        },
        'background-color-error': `var(${vars['control.background-color-error']}, var(--token-semantic-color-feedback-error-solid, var(--token-global-material-error-40, oklch(0.50128208 0.17831791 28.704727))))`,
        ...
        'checked': {
            'background-color': `var(${vars['control.checked.background-color']}, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`,
            'background-color-hover': `var(${vars['control.checked.background-color-hover']}, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`,
        ...
        'indeterminate': {
            'background-color': `var(${vars['control.indeterminate.background-color']}, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`,
            'border-color': `var(${vars['control.indeterminate.border-color']}, var(--token-semantic-color-brand-primary, var(--token-global-purple-40, oklch(0.49552086 0.13045663 293.709078))))`
        },
        'background-color-disabled': `var(${vars['control.background-color-disabled']}, transparent)`,
        'selection': {
            'background-color-disabled': `var(${vars['control.selection.background-color-disabled']}, var(--token-semantic-color-text-primary, var(--token-global-material-neutral-10, oklch(0.22652446 0.00999107 303.713695))))`
        },
    ...
    'icon': {
        ...
        'scale': `var(${vars['icon.scale']}, 1)`,
        'checked': {
            'color': `var(${vars['icon.checked.color']}, var(--token-semantic-color-text-on-brand, var(--token-global-white, oklch(1.000 0 0))))`
        },
        'indeterminate': {
            'color': `var(${vars['icon.indeterminate.color']}, var(--token-semantic-color-text-on-brand, var(--token-global-white, oklch(1.000 0 0))))`
        },
        'color-disabled': `var(${vars['icon.color-disabled']}, var(--token-semantic-color-surface-content, var(--token-semantic-color-background-surface, var(--token-global-material-neutral-98, oklch(0.98379491 0.01284496 321.893957)))))`
    },
    'state-layer': {
    ...
    'size': {
        ...
        'small': {
            ...
            'icon': {
                'width': `var(${vars['size.small.icon.width']}, 16px)`
            },
            'label': {
