...
export const vars = {
    ...
    'horizontal.item.divider-color-hover': '--menu-horizontal-item-divider-color-hover',
    ...
    'horizontal.group-item.title.opacity': '--menu-horizontal-group-item-title-opacity',
    'horizontal.group-item.header.padding-inline': '--menu-horizontal-group-item-header-padding-inline',
    'horizontal.group-item.icon.opacity': '--menu-horizontal-group-item-icon-opacity',
...
const token = {
    ...
    'horizontal': {
        ...
        'submenu': {
            ...
            'border-radius': `var(${vars['horizontal.submenu.border-radius']}, 4px)`
        },
        'group-item': {
            'indent-base': `var(${vars['horizontal.group-item.indent-base']}, 5px)`,
            'indent-scale': `var(${vars['horizontal.group-item.indent-scale']}, 0.7)`,
            'font-size': `var(${vars['horizontal.group-item.font-size']}, 14px)`,
            'margin': `var(${vars['horizontal.group-item.margin']}, 6px 0px)`,
            'transition': `var(${vars['horizontal.group-item.transition']}, border-color 0.3s, color 0.3s)`,
            'title': {
                'opacity': `var(${vars['horizontal.group-item.title.opacity']}, 0.5)`
            },
            'header': {
                'padding-inline': `var(${vars['horizontal.group-item.header.padding-inline']}, 16px)`
            },
            'icon': {
                'opacity': `var(${vars['horizontal.group-item.icon.opacity']}, 0.5)`,
                'margin-right': `var(${vars['horizontal.group-item.icon.margin-right']}, 8px)`
            }
        }
    }
};
