...
const token = defineTokens({
    'rail': {
        ...
        'fill-active': `var(${vars['rail.fill-active']}, var(--slider-rail-active-fill, var(--token-semantic-color-brand-primary, var(--token-global-zinc-900, oklch(0.220 0.005 286)))))`
    },
    'thumb': {
        ...
        'stroke-color': `var(${vars['thumb.stroke-color']}, var(--token-semantic-color-brand-primary, var(--token-global-zinc-900, oklch(0.220 0.005 286))))`,
        ...
        'halo': {
            ...
            'fill': `var(${vars['thumb.halo.fill']}, var(--token-semantic-color-brand-primary, var(--token-global-zinc-900, oklch(0.220 0.005 286))))`
        }
    }
});
